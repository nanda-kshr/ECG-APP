...
class _TaskDetailScreenState extends State<TaskDetailScreen> {
  ...
  static const Color _backgroundColor = Color(0xFFE3F2FD); // Light blue background
  ...
  void _showFullScreenImage(BuildContext context, String imageUrl, PatientImage image) {
  ...
  Widget build(BuildContext context) {
    ...
    sortedImages.sort((a, b) {
      ...
      return a.createdAt!.compareTo(b.createdAt!); // Ascending so newest at bottom
    });
              ...
              children: [
                ...
                _buildInfoBubble(
                  ...
                  items: [
                    ...
                    if (task.patientAge != null) ('Age', '${task.patientAge} years'),
                    ('Technician', task.technicianName ?? 'N/A'),
                ...
                // Technician notes bubble
                if (task.technicianNotes != null && task.technicianNotes!.isNotEmpty) ...[
                  _buildMessageBubble(
                    sender: task.technicianName ?? 'Technician',
                    message: task.technicianNotes!,
                    time: task.createdAt,
                    isFromMe: false,
                    senderRole: 'Technician Notes',
                    bubbleColor: _primaryLight,
                  ),
                  const SizedBox(height: 12),
                ],
                ...
                if (isPatient && task.doctorFeedback != null && task.doctorFeedback!.isNotEmpty) ...[
                  _buildMessageBubble(
                ...
                // Bottommost technician notes (visible to all roles)
                if (task.technicianNotes != null && task.technicianNotes!.isNotEmpty) ...[
                  _buildMessageBubble(
                    sender: task.technicianName ?? 'Technician',
                    message: task.technicianNotes!,
  ...
  Widget _buildSystemMessage(String text, {bool isError = false, bool isSuccess = false}) {
